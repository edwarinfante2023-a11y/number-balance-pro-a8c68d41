    ...
    <div className="space-y-6 pt-2">
      <div className="mb-8">
        ...
        <p className="text-[15px] text-muted-foreground mt-1">
          Terminal de captura directa. El clasificador evalúa el input en tiempo real aplicando los
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <form
          ...
          className="lg:col-span-7 bg-white rounded-[24px] lg:rounded-[32px] p-5 sm:p-8 lg:p-10 border border-border shadow-sm flex flex-col relative"
        >
        ...
        <div className="lg:col-span-5 bg-white rounded-[24px] lg:rounded-[32px] p-5 sm:p-8 lg:p-10 border border-border shadow-sm flex flex-col relative overflow-hidden group">
          ...
          <div
            className={cn(
              ...
              valid
                ? "size-[500px] bg-primary/5 scale-100 opacity-100"
                : "size-[0px] bg-transparent scale-50 opacity-0",
            )}
          />
          ...
          <div className="flex-1 flex flex-col relative z-10 w-full">
            {valid && c ? (
              <div className="flex-1 flex flex-col animate-fade-in">
                ...
                <div className="mt-auto bg-emerald-50/50 rounded-[20px] border border-emerald-100 p-6">
                  ...
                  <ul className="text-[13px] text-emerald-800/80 font-medium space-y-3">
                    ...
                    <li className="flex items-center gap-3">
                      <span className="text-emerald-500 font-bold">{">"}</span>
                      Subcuadrante consolidado{" "}
                      <strong className="font-bold text-emerald-700 ml-1">
                        {c.subcuadrante.replace("_", "")}
                      </strong>
                    </li>
                  </ul>
                </div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8 bg-muted/30 rounded-[24px] border border-dashed border-border flex-grow">
                ...
                <div className="text-[16px] font-bold text-foreground mb-2">Esperando Entidad</div>
                <div className="text-[13px] text-muted-foreground leading-relaxed max-w-[250px]">
                  Aplica un valor en el rango global [{config.rangeMin} - {config.rangeMax}] para
                  disparar el motor.
                </div>
              </div>
            )}
