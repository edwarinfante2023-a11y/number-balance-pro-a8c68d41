    ...
    <div className="space-y-6 pt-2">
      <div className="mb-8">
        ...
        <p className="text-[15px] text-muted-foreground mt-1">
          Query builder de extracción. Formatea sub-conjuntos para análisis externo o revisión
          algorítmica.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-8 bg-white rounded-[32px] border border-border shadow-sm p-8 lg:p-10 relative flex flex-col">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-6 flex-1">
            <Field label="Rango Inicial (Desde)">
              <input
                type="date"
                className="w-full h-14 px-5 rounded-[16px] bg-muted/50 border border-border text-[15px] font-semibold text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-inner"
              />
            </Field>
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="bg-white rounded-[32px] border border-border shadow-sm p-8">
            <div className="text-[12px] font-bold uppercase tracking-[0.1em] text-muted-foreground mb-6">
              Export Engine
            </div>
            ...
            <tbody className="divide-y divide-border">
              {[
                ...
                <tr key={i} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-8 py-5 text-[14px] font-semibold text-muted-foreground tabular-nums">
                    {r.s}
                  </td>
                  <td className="px-8 py-5 text-[14px] font-semibold text-muted-foreground tabular-nums">
                    {r.d}
